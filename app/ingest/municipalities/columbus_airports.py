...
AGENCY_NAME = "Columbus Regional Airport Authority (CRAA)"
BASE_URL = "https://columbusairports.gob2g.com"
...
DETAIL_URL_TEMPLATE = BASE_URL + "/FrontEnd/ProposalSearchPublicDetail.asp?TN=columbusairports&RID={RID}"
...
def _locate_opportunity_tiles(soup: BeautifulSoup) -> List[dict]:
    ...
    for tile in tiles:
        ...
        if status_text.strip().lower() != "open":
            continue
